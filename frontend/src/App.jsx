...
function App() {
  ...
  return (
    <BrowserRouter>
     <div className="text-white min-h-screen w-screen bg-black scrollbar-hidden">
      ...
      <Routes>
        ...
        <Route path="/messages" element={isLoggedIn ? <ChatInterface /> :<Signup  />} />
        ...
        <Route path="/campaign/:id" element={isLoggedIn ? <CampaignDetails />:<Signup />} />
        <Route path="/chat/:username" element={isLoggedIn ?<ChatInterface />:<Signup />} />
      </Routes>
